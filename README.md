...
EndPoint : /v1/coupons/issue
Method : POST 
Description : 사용자에게 쿠폰 발급
Return value: HTTP status 201 (Created) 
{
    "success": true,
    "code": 0,
    "msg": "g01053T0t0b0Pl33"
}
...
Payload Example (required parameters)
- http://{CouponApiServer}/v1/coupons/use

----------------------------------------------------------------------------------------------------

EndPoint : /v1/coupons/cancel
Method : PUT 
Description : 생성된 쿠폰중 하나를 사용자에게 지급 
              사용자에게 지급한 쿠폰을 취소
Return value: 
...
Payload Example (required parameters)
- http://{CouponApiServer}/v1/coupons/cancel?couponNum=d0Q050F1h0i0xF3y

|-----------|--------------|---------------------------------------------------|
| Parameter |Parameter Type| Description                                       |
|-----------|--------------|---------------------------------------------------|
| couponNum | String       | 취소할 Coupon number                                |
|-----------|--------------|---------------------------------------------------|
